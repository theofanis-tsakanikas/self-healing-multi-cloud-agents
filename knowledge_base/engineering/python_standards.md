...
> **Requirements standard moved.** The `requirements.txt` spec (CODE-OWNED) now lives in
> `python_requirements_standard.md` — a code-owned spec does not belong in this LLM generation standard,
> and splitting it keeps this file under the embedding token limit.
