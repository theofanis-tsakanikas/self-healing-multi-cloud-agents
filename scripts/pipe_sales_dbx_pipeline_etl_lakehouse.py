...
def run():
    logging.info("Databricks pipeline starting: pipe_sales_dbx_pipeline_etl_lakehouse")
    ...
    table = f"{catalog}.{schema}.pipe_sales_dbx_pipeline_etl_lakehouse"
    audit_table = f"{catalog}.{schema}.pipe_sales_dbx_pipeline_etl_lakehouse_audit"
