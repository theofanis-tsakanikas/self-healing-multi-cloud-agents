...
def run():
    logging.info("Databricks pipeline starting: pipe_sales_orders_pipeline_v1_lakehouse")
    ...
    table = f"{catalog}.{schema}.pipe_sales_orders_pipeline_v1_lakehouse"
    audit_table = f"{catalog}.{schema}.pipe_sales_orders_pipeline_v1_lakehouse_audit"
