...
def run():
    logging.info("Pipeline starting: pipe_etl_gcp_pipeline_to_gcp")  # ← MUST be the very first line
    ...
    try:
        ...
        for i, chunk in enumerate(pd.read_sql_query(query, engine, chunksize=1000)):
            ...
            # Rule 5: Flag impossible engagement (CTR > 100%) for downstream review
