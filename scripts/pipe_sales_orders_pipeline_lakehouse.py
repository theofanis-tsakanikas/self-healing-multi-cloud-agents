...
def run():
    logging.info("Databricks pipeline starting: pipe_sales_orders_pipeline_lakehouse")
    ...
    table = f"{catalog}.{schema}.pipe_sales_orders_pipeline_lakehouse"
    audit_table = f"{catalog}.{schema}.pipe_sales_orders_pipeline_lakehouse_audit"
