...
def run():
    logging.info("Databricks pipeline starting: pipe_sales_orders_pipeline_v3_lakehouse")
    ...
    table = f"{catalog}.{schema}.pipe_sales_orders_pipeline_v3_lakehouse"
    audit_table = f"{catalog}.{schema}.pipe_sales_orders_pipeline_v3_lakehouse_audit"
